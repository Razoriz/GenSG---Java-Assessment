...
{
    private final Map<String, Course> courses = new HashMap<>(); //courseID and the course itself

    private final Map<String, List<Student>> enrolledStudents = new HashMap<>(); //courseID and the list of students enrolled in that course
